...
// document.getElementById('hide2').onclick = (buttom) => {
...
// let lorem = {title : 'lorem', body:'lorem ipsum dolo sit ameti'};
...
// let censyre = ['bla-bla', 'lala'];
// censyre.document.getElementById;
